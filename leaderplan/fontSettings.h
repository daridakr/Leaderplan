...
namespace leaderplan {
	...
	private: 
		...
		Bunifu::Framework::UI::BunifuFlatButton^ changedFontButton;
		Bunifu::Framework::UI::BunifuFlatButton^ changedColorButton;
	...
	#pragma region Windows Form Designer generated code
			void InitializeComponent(void)
			{
				...
				this->changedFontButton->ButtonText = L"   �������� �����";
				...
				this->changedColorButton->ButtonText = L"   �������� ����";

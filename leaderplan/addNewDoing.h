...
namespace leaderplan {
	...
	public:
		...
		DevComponents::DotNetBar::ColorPickerButton^ colorOfTextDoing;
		DevComponents::DotNetBar::ColorPickerButton^ colorOfBackColorDoing;
	...
	System::Windows::Forms::PictureBox^ expandWindowButton;
	System::Windows::Forms::RichTextBox^ descriptionOfDoingTextBox;
	System::Windows::Forms::Panel^ topPanel;
	System::Windows::Forms::ComboBox^ choiceOfLevelOfDoingImportance;
	System::Windows::Forms::Button^ addDoingButton;
	System::Windows::Forms::DateTimePicker^ choiceOfDeadline;
	System::Windows::Forms::Label^ necessarilyItemLabel;
	System::Windows::Forms::GroupBox^ allElementsRight;
	System::Windows::Forms::PictureBox^ minimizeWindowButton;
	System::Windows::Forms::CheckBox^ isDeadline;
	System::Windows::Forms::GroupBox^ allElementsLeft;
	System::Windows::Forms::ColorDialog^ colorDialog1;
	System::Windows::Forms::ColumnHeader^ columnHeader3;
	System::Windows::Forms::ColumnHeader^ columnHeader4;
	System::ComponentModel::IContainer^ components;
	System::Windows::Forms::CheckBox^ isBackColor;
	System::Windows::Forms::CheckBox^ isColorOfText;
	System::Windows::Forms::ListView^ allDoingsList;
	Bunifu::Framework::UI::BunifuElipse^ bunifuElipse1;
	Bunifu::Framework::UI::BunifuDragControl^ moverByFirstGroupBox;
	Bunifu::Framework::UI::BunifuDragControl^ moverByText;
	Bunifu::Framework::UI::BunifuCustomLabel^ titleOfWindow;
	Bunifu::Framework::UI::BunifuCustomLabel^ descriptionLabel;
	Bunifu::Framework::UI::BunifuCustomLabel^ nameOfDoingLabel;
	Bunifu::Framework::UI::BunifuCustomLabel^ importanceOfDoingLabel;
	Bunifu::Framework::UI::BunifuCustomLabel^ deadlineLabel;
	Bunifu::Framework::UI::BunifuCustomLabel^ colorOfTextDoingLabel;
	Bunifu::Framework::UI::BunifuDragControl^ moverByTopPanel;
	Bunifu::Framework::UI::BunifuDragControl^ moverBySecondGroupBox; 
	Bunifu::Framework::UI::BunifuCustomLabel^ colorOfBackColorDoingLabel;
	Bunifu::Framework::UI::BunifuCustomLabel^ listOfAllDoingsLabel;
	DevComponents::DotNetBar::StyleManager^ styleManager1;
	DevComponents::DotNetBar::ButtonItem^ buttonItem1;
	DevComponents::DotNetBar::ButtonItem^ buttonItem2;
	DevComponents::DotNetBar::ItemContainer^ itemContainer1;
	DevComponents::DotNetBar::GalleryContainer^ galleryContainer1;
	DevComponents::DotNetBar::ComboBoxItem^ comboBoxItem1;
	DevComponents::DotNetBar::LabelItem^ labelItem1;
	DevComponents::DotNetBar::CheckBoxItem^ checkBoxItem1;
	DevComponents::DotNetBar::CheckBoxItem^ checkBoxItem2;
	DevComponents::DotNetBar::SliderItem^ sliderItem1;
	DevComponents::DotNetBar::ColorPickerDropDown^ colorPickerDropDown1;
	DevComponents::DotNetBar::ColorPickerDropDown^ colorPickerDropDown2;
	DevComponents::DotNetBar::ColorPickerDropDown^ colorPickerDropDown3;
	DevComponents::DotNetBar::Controls::Line^ line3;
	DevComponents::DotNetBar::Controls::Line^ line1;
	DevComponents::DotNetBar::Controls::TextBoxX^ nameOfDoingTextBox;

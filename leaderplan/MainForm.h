...
namespace leaderplan {
	...
	public:
	private: System::Windows::Forms::ToolStripMenuItem^ списокВсехДелToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ сделатьСегодняToolStripMenuItem;

	private: System::Windows::Forms::ToolStripMenuItem^ темыToolStripMenuItem;

	private: System::Windows::Forms::ToolStripMenuItem^ сохранитьБезДедлайнаToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ списокВсехДелToolStripMenuItem1;
	private: System::Windows::Forms::ToolStripMenuItem^ сделатьСегодняToolStripMenuItem1;
	private: System::Windows::Forms::ToolStripMenuItem^ восстановитToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ навигацияToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ доскаСписковДелToolStripMenuItem;
	...
	private: System::Windows::Forms::ToolStripMenuItem^ подведениеИтоговToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ калорииИВесToolStripMenuItem;
	...
	private: WindowsFormsControlLibrary1::BunifuCustomTextbox^ searchForDoings;


	private: System::Windows::Forms::PictureBox^ leaderplan;

	private: System::Windows::Forms::PictureBox^ leaderplanIcon;
	private: Bunifu::Framework::UI::BunifuCustomLabel^ allDoingsLabel;


	private: Bunifu::Framework::UI::BunifuCustomLabel^ nextTaskLabel;
	private: Bunifu::Framework::UI::BunifuCustomLabel^ currentDateLabel;



	private: Bunifu::Framework::UI::BunifuCustomLabel^ currentTaskLabel;


	private: System::Windows::Forms::PictureBox^ closeProgram;
	private: System::Windows::Forms::PictureBox^ minimizeWindow;


	private: System::Windows::Forms::PictureBox^ hideProgram;
	private: System::Windows::Forms::PictureBox^ threeDots;
	...
	private: Bunifu::Framework::UI::BunifuFlatButton^ remindersButton;
	private: Bunifu::Framework::UI::BunifuFlatButton^ notesButton;
	private: Bunifu::Framework::UI::BunifuFlatButton^ healthButton;
	private: Bunifu::Framework::UI::BunifuFlatButton^ resultsButton;
	private: Bunifu::Framework::UI::BunifuFlatButton^ statisticsButton;
	private: Bunifu::Framework::UI::BunifuFlatButton^ calendarButton;
	private: Bunifu::Framework::UI::BunifuFlatButton^ projectsButton;
	private: Bunifu::Framework::UI::BunifuFlatButton^ aimsButton;
	private: System::Windows::Forms::Panel^ sidePanel;

	private: Bunifu::Framework::UI::BunifuFlatButton^ boardButton;



	private: Bunifu::Framework::UI::BunifuSeparator^ separator_3;
	...
	private: Bunifu::Framework::UI::BunifuCustomLabel^ alreadyDoneLabel;



	private: Bunifu::Framework::UI::BunifuCustomLabel^ doTodayLabel;
...
private: System::Windows::Forms::PictureBox^ maximizeWindow;
private: Bunifu::Framework::UI::BunifuDragControl^ moverTopPanel;
private: Bunifu::Framework::UI::BunifuDragControl^ moverMenu;
private: System::Windows::Forms::GroupBox^ firstList;

private: System::Windows::Forms::PictureBox^ addNewDoingButton;
private: System::Windows::Forms::GroupBox^ secondList;
private: System::Windows::Forms::GroupBox^ thirdList;
private: System::Windows::Forms::PictureBox^ sortingListButton;
private: System::Windows::Forms::GroupBox^ sortingBox;
private: System::Windows::Forms::RadioButton^ byUserChoice;




private: System::Windows::Forms::RadioButton^ byImportance;
private: System::Windows::Forms::PictureBox^ sortingListButton2;
private: System::Windows::Forms::RadioButton^ byDefault;
private: System::Windows::Forms::Panel^ panel2;
private: System::Windows::Forms::Label^ listIsEmptyLabel;


private: System::Windows::Forms::ToolStripMenuItem^ справкаToolStripMenuItem;
private: System::Windows::Forms::ToolStripMenuItem^ оРазработчикеToolStripMenuItem;
public: System::Windows::Forms::ListView^ doingsList;
private: System::Windows::Forms::PictureBox^ sortingForDoingsListButton;
private: System::Windows::Forms::GroupBox^ sortingForDoingsListBox;
private: System::Windows::Forms::RadioButton^ byDefaultDL;

private: System::Windows::Forms::RadioButton^ byUserChoiceDL;

private: System::Windows::Forms::RadioButton^ byImportanceDL;

private: System::Windows::Forms::PictureBox^ sortingForDoingsListButton2;
private: System::Windows::Forms::RadioButton^ byDatesChoice;
private: System::Windows::Forms::PictureBox^ sortingListButton_2;
private: System::Windows::Forms::ColumnHeader^ columnHeader1;
private: System::Windows::Forms::ColumnHeader^ columnHeader2;
private: System::Windows::Forms::Label^ currentDate;
private: System::Windows::Forms::Label^ isAnythingTodayLabel;


public: System::Windows::Forms::ListView^ doingsTodayList;
private:
...
private: System::Windows::Forms::PictureBox^ toDelete;
private: System::Windows::Forms::PictureBox^ toDeleteInactive;
private: System::Windows::Forms::Label^ amountOfDoingsLabel;
private: System::Windows::Forms::Label^ amountOfDoings;
private: System::Windows::Forms::PictureBox^ doneButton;
private: System::Windows::Forms::GroupBox^ doneOptions;
private: System::Windows::Forms::Button^ saveDoings;


private: System::Windows::Forms::Button^ deleteAllDoings;

private: System::Windows::Forms::PictureBox^ donePictureBox2;
private: System::Windows::Forms::Label^ countOfDoingsToday;
private: System::Windows::Forms::Label^ nextDoing;
private: System::Windows::Forms::Label^ currentDoing;
private: System::Windows::Forms::Panel^ panel6;
private: System::Windows::Forms::RichTextBox^ doneList;
private: System::Windows::Forms::Label^ isNothingLabel;
	...
	try
	{
		if (doingsList->Items->Count != 0)
		{
			...
			for (int i = 0; i < doingsList->Items->Count; i++)
			{
				...
				//writer->Write(doingsList->Items[i]->SubItems[i]->Text);
				//writer->Write(Convert::ToString(doingsList->Items[i]->BackColor));
				//writer->Write(Convert::ToString(doingsList->Items[i]->ForeColor));
			}
			for (int i = 0; i < doingsList->Items->Count; i++)
			{
	...
	try
	{
		if (doingsTodayList->Items->Count != 0)
		{
			...
			for (int i = 0; i < doingsTodayList->Items->Count; i++)
			{
				...
				//writer->Write(doingsTodayList->Items[i]->SubItems[i]->Text);
				//writer->Write(Convert::ToString(doingsTodayList->Items[i]->BackColor));
				//writer->Write(Convert::ToString(doingsTodayList->Items[i]->ForeColor));
			}
			for (int i = 0; i < doingsTodayList->Items->Count; i++)
			{
...
private: System::Void MainForm_Load(System::Object^ sender, System::EventArgs^ e)
{
	...
	//this->bunifuElipse1->ApplyElipse(panel1, 100); //для скругления краёв поля
}
...
private: System::Void doingsList_ItemMouseHover(System::Object^ sender, System::Windows::Forms::ListViewItemMouseHoverEventArgs^ e)
{
	//отображение уровня важности каждой задачи
}
...
private: System::Void восстановитToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
